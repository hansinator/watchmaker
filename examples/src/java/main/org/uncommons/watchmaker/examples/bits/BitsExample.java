...
public class BitsExample
{
    ...
    public static BitString evolveBits(int length)
    {
        ...
        EvaluationStrategy<BitString> evaluationStrategy = new IndividualFitnessEvaluationStrategy<BitString>(new BitStringEvaluator());
        evaluationStrategy.setSingleThreaded(true); // Performs better for very trivial fitness evaluations.
